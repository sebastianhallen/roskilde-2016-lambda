...
describe('Slack message', function() {
  ...
  describe('forActsByStage', () => {
    const message = slackMessage.forActsByStage(acts, 'Friday');
    ...
    it('should format message grouped by stage', done => {
      const orange = byStage('Orange');
      const arena = byStage('Arena');
      const avalon = byStage('Avalon');
